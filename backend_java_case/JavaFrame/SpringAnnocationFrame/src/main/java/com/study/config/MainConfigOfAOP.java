 ...
 * 
 * 1.����aopģ��: Spring AOP : (spring-aspects)
 * 2.����һ��ҵ���߼��� (MathCalculator),��ҵ���߼����е�ʱ����־���д�ӡ,�ڷ���֮ǰ,�������н���,�����쳣,�����ӡ��־
 * 3.����һ����־������(LogAspects)������������ķ�����Ҫ��̬��֪MathCalculator���е�����,Ȼ��ִ��
 * 		֪ͨ������
 * 			ǰ��֪ͨ(@Before)��logStart		���п�ʼ�����
 * 			����֪ͨ(@After)��logEnd	���н��������,�������������쳣
 * 			����֪ͨ(@AfterReturning)��logReturn 	�������غ�����
 * 			�쳣֪ͨ(@AfterThrowing)��logException 	�쳣���غ����� 
 * 			����֪ͨ(@Around)����̬�����ֶ��ƽ�Ŀ�귽������(joinPoint.procced())
 * 4.���������Ŀ�귽����ע��ʱ�ε�����(֪ͨע��)
 * 5.���������ҵ���߼���(Ŀ�귽��������)������������
 * 6.�������Spring�ĸ�����������(����Aspect)
